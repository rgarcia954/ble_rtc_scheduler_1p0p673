...
#endif    /* ifndef APP_ADV_CONNECTABILITY_MODE */
...
#define TASK0_RUN_ACTIVITY_GPIO            4
#define TASK1_RUN_ACTIVITY_GPIO            4
#define TASK2_RUN_ACTIVITY_GPIO            4

#else    /* if APP_PLATFORM == DEXCOM_HARDWARE */
#define POWER_MODE_GPIO                 7

#define TASK0_RUN_ACTIVITY_GPIO            9
#define TASK1_RUN_ACTIVITY_GPIO            10
#define TASK2_RUN_ACTIVITY_GPIO            11
#endif    /* if APP_PLATFORM == DEXCOM_HARDWARE */
...
#else    /* if defined (CFG_REDUCED_DRAM) */
#define APP_DEVICE_NAME                 "ble_rtc_scheduler"
#endif    /* if defined (CFG_REDUCED_DRAM) */
...
#define BLE_ADV_ON_DURATION     7    /* In units of seconds */
#define BLE_ADV_OFF_DURATION    53    /* In units of seconds */
